...
final class ImportService extends Service
{
        ...
        switch ($identity) {
            ...
            case 'space':
                ...
                if (!empty($importSpaceExcel[1])) {
                    ...
                    $this->crmBuildingSpaceRepository->insertExcel($importSpaceExcel[0]);
                }
                break;
            ...
            case 'clear-space':
                ...
                if (!empty($importSpaceExcel[1])) {
                    ...
                    $this->crmBuildingSpaceRepository->delete();
                    $this->crmBuildingSpaceRepository->insertExcel($importSpaceExcel[0]);
                }
                break;
    ...
    private function ImportSpaceExcel($file)
    {
        ...
        $importedData = (new FastExcel())->import($file, function ($row) use ($fetchOptionGroupBy, &$errorMessages, &$currentRowNumber) {
            ...
            $keys = ['district', 'building', 'staircase', 'floor', 'privacy'];
     ...
     * @return array
     */
    private function mapCommonFields($rowValues): array
    {
        return [
            ...
            'main_application'          => array_flip(CrmHouseType::array())[$rowValues[12]] ?? null,
            'land_use_zoning'           => array_flip(LandUseZoningType::array())[$rowValues[13]] ?? null,
        ];
    }
}