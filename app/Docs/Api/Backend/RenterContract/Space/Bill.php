...
class Bill
{
    /**
     * @OA\Post(
     *      path="/renter/space/{spaceId}/contract/{contractUuid}/bill",
     *      operationId="CreateSpaceContractBill",
     *      tags={"Renter Contract 戶別合約"},
     *      summary="建立單筆戶別合約帳單",
     *      description="建立單筆戶別合約帳單",
    ...
    /**
     * @OA\Patch(
     *      path="/renter/space/{spaceId}/contract/{contractUuid}/bill/{uuid}",
     *      operationId="UpdateAloneSpaceContractBill",
     *      tags={"Renter Contract 戶別合約"},
     *      summary="修改單筆戶別合約帳單",
     *      description="修改單筆戶別合約帳單",
     *      security={{"Authorization":{}}, {"Community-Id-Header":{}}},
     *      @OA\Parameter(
     *          name="spaceId",
     *          description="戶別 ID",
     ...
     * @OA\Delete(
     *      path="/renter/space/{spaceId}/contract/{contractUuid}/bill/{uuid}",
     *      operationId="DeleteAloneSpaceContractBill",
     *      tags={"Renter Contract 戶別合約"},
     *      summary="刪除單筆戶別合約帳單",
     *      description="刪除單筆戶別合約帳單",
     *      security={{"Authorization":{}}, {"Community-Id-Header":{}}},
     *      @OA\Parameter(
     *          name="spaceId",
     *          description="戶別 ID",
