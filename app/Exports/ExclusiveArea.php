...
use App\Exports\Component\Area\ExclusiveHeader;

class ExclusiveArea implements WithHeadings, WithTitle, WithEvents
{
    use Exportable;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event): void {
                (new ExclusiveHeader($event))->setHeaderStyle();
    ...
    private function setHeaderTextRun(AfterSheet $event): void
    {
        ...
        $event->sheet->getDelegate()->getComment('B1')->getText()->createTextRun('說明：請輸入面積名稱，格式為文字，最大字元：255');
